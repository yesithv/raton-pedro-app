...
export default {
  ...
  inicio: {
    ...
    videoPie: "Na segunda versão",
    proximamente: "Em breve",
    videoAviso: "O vídeo chega na segunda versão.\nPara já, a foto e a carta.",
    foto: "Foto com ele",
  ...
  opciones: {
    ...
    listo: "Pronto",
    raton: "Rato da foto",
    ratonPie: "O que aparece ao tirar a foto. O da carta escolhe-se ao escrevê-la.",
  ...
  carta: {
    ...
    queRaton: "Que Rato vem à carta?",
    queRatonAyuda: "Vai desenhado em baixo, ao lado da assinatura.",
