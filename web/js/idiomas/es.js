...
export default {
  ...
  inicio: {
    ...
    videoPie: "En la segunda versión",
    proximamente: "Próximamente",
    videoAviso: "El vídeo llega en la segunda versión.\nPor ahora, la foto y la carta.",
    foto: "Foto con él",
  ...
  opciones: {
    ...
    ratonPie: "El que sale al hacer la foto. El de la carta se elige al escribirla.",
  ...
  carta: {
    ...
    queRaton: "¿Qué Ratón viene a la carta?",
    queRatonAyuda: "Va dibujado abajo, junto a la firma.",
